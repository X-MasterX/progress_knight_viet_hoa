...
const jobBaseData = {
    "Beggar": { name: "Beggar", displayName: "Ăn Mày", maxXp: 50, income: 5, heroxp: 36 },
    "Farmer": { name: "Farmer", displayName: "Nông Dân", maxXp: 100, income: 9, heroxp: 37 },
    "Fisherman": { name: "Fisherman", displayName: "Ngư Dân", maxXp: 200, income: 15, heroxp: 38 },
    "Miner": { name: "Miner", displayName: "Thợ Mỏ", maxXp: 400, income: 40, heroxp: 39 },
    "Blacksmith": { name: "Blacksmith", displayName: "Thợ Rèn", maxXp: 800, income: 80, heroxp: 40 },
    "Merchant": { name: "Merchant", displayName: "Thương Nhân", maxXp: 1600, income: 150, heroxp: 41 },

    "Squire": { name: "Squire", displayName: "Người Hầu", maxXp: 42, income: 5, heroxp: 51 },
    "Footman": { name: "Footman", displayName: "Lính Bộ Binh", maxXp: 1000, income: 50, heroxp: 52 },
    "Veteran footman": { name: "Veteran footman", displayName: "Cựu Binh", maxXp: 10000, income: 120, heroxp: 53 },
    "Centenary": { name: "Centenary", displayName: "Bách Quân", maxXp: 100000, income: 300, heroxp: 54 },
    "Knight": { name: "Knight", displayName: "Hiệp Sĩ", maxXp: 1000000, income: 1000, heroxp: 57 },
    "Veteran Knight": { name: "Veteran Knight", displayName: "Hiệp Sĩ Kỳ Cựu", maxXp: 7500000, income: 3000, heroxp: 61 },
    "Holy Knight": { name: "Holy Knight", displayName: "Thánh Kỵ Sĩ", maxXp: 4e7, income: 5000, heroxp: 64 },
    "Lieutenant General": { name: "Lieutenant General", displayName: "Trung Tướng", maxXp: 1.5e8, income: 50000, heroxp: 77 },

    "Student": { name: "Student", displayName: "Học Sinh", maxXp: 1e5, income: 100, heroxp: 79 },
    "Apprentice Mage": { name: "Apprentice Mage", displayName: "Pháp Sư Tập Sự", maxXp: 1e6, income: 1000, heroxp: 82 },
    "Adept Mage": { name: "Adept Mage", displayName: "Pháp Sư Lành Nghề", maxXp: 1e7, income: 9500, heroxp: 82 },
    "Master Wizard": { name: "Master Wizard", displayName: "Bậc Thầy Phép Thuật", maxXp: 1e8, income: 70000, heroxp: 95 },
    "Archmage": { name: "Archmage", displayName: "Đại Pháp Sư", maxXp: 1e10, income: 350000, heroxp: 95 },
    "Chronomancer": { name: "Chronomancer", displayName: "Pháp Sư Thời Gian", maxXp: 2e12, income: 1000000, heroxp: 95 },
    "Chairman": { name: "Chairman", displayName: "Chủ Tịch", maxXp: 2e13, income: 10000000, heroxp: 106 },
    "Imperator": { name: "Imperator", displayName: "Hoàng Đế", maxXp: 9e15, income: 60000000, heroxp: 129 },

    "Corrupted": { name: "Corrupted", displayName: "Kẻ Tham Nhũng", maxXp: 1e14, income: 2.5e7, heroxp: 131 },
    "Void Slave": { name: "Void Slave", displayName: "Nô Lệ Hư Không", maxXp: 6.5e14, income: 2e8, heroxp: 134 },
    "Void Fiend": { name: "Void Fiend", displayName: "Ác Ma Hư Không", maxXp: 1.8e16, income: 6e8, heroxp: 237 },
    "Abyss Anomaly": { name: "Abyss Anomaly", displayName: "Dị Biến Vực Thẳm", maxXp: 1.8e16, income: 1.2e9, heroxp: 237 },
    "Void Wraith": { name: "Void Wraith", displayName: "Bóng Ma Hư Không", maxXp: 1.8e17, income: 5e9, heroxp: 238 },
    "Void Reaver": { name: "Void Reaver", displayName: "Kẻ Cướp Hư Không", maxXp: 2.6e18, income: 2.5e10, heroxp: 238 },
    "Void Lord": { name: "Void Lord", displayName: "Chúa Tể Hư Không", maxXp: 2.8e19, income: 1e11, heroxp: 238 },
    "Abyss God": { name: "Abyss God", displayName: "Thần Vực Thẳm", maxXp: 4e20, income: 1e12, heroxp: 250 },

    "Eternal Wanderer": { name: "Eternal Wanderer", displayName: "Kẻ Lang Thang Vĩnh Hằng", maxXp: 5.5e19, income: 1e12, heroxp: 250 },
    "Nova": { name: "Nova", displayName: "Tân Tinh", maxXp: 5.1e19, income: 3e12, heroxp: 250 },
    "Sigma Proioxis": { name: "Sigma Proioxis", displayName: "<span style='color: #ff00ff;'>Khởi Nguyên Tối Thượng</span>", maxXp: 5e20, income: 2.15e13, heroxp: 260 },
    "Acallaris": { name: "Acallaris", displayName: "<span style='color: #00ffff;'>Vị Thần Acallaris</span>", maxXp: 5e22, income: 2.15e14, heroxp: 263 },
    "One Above All": { name: "One Above All", displayName: "<span style='color: #ff0000; font-weight: bold;'>Đấng Tối Cao</span>", maxXp: 5e27, income: 2.5e16, heroxp: 265 },

    "Snow Crash": { name: "Snow Crash", displayName: "<span style='color: #ffffff; text-shadow: 0 0 5px #000;'>Bão Tuyết Hủy Diệt</span>", maxXp: Infinity, income: 2.5e52, heroxp: 1015 },
    "Player One": { name: "Player One", displayName: "<span style='color: #ffd700;'>Người Chơi Số 1</span>", maxXp: Infinity, income: 2.5e54, heroxp: 1200 },
    "Lost in the dark": { name: "Lost in the dark", displayName: "Lạc Trong Bóng Tối", maxXp: Infinity, income: 2.5e58, heroxp: 1358 },
    "Omega": { name: "Omega", displayName: "<span style='color: #ff3300;'>Điểm Cuối Omega</span>", maxXp: Infinity, income: 2.5e62, heroxp: 3120 },
}

const skillBaseData = {
    "Concentration": { name: "Concentration", displayName: "Tập Trung", maxXp: 100, heroxp: 36, effect: 0.01, description: "XP Kỹ năng" },
    "Productivity": { name: "Productivity", displayName: "Năng Suất", maxXp: 100, heroxp: 37, effect: 0.01, description: "XP Anh Hùng" },
    "Bargaining": { name: "Bargaining", displayName: "Mặc Cả", maxXp: 100, heroxp: 38, effect: -0.01, description: "Giảm chi phí" },
    "Meditation": { name: "Meditation", displayName: "Thiền Định", maxXp: 100, heroxp: 39, effect: 0.01, description: "Hạnh phúc" },

    "Strength": { name: "Strength", displayName: "Sức Mạnh", maxXp: 100, heroxp: 40, effect: 0.01, description: "Lương quân sự" },
    "Battle Tactics": { name: "Battle Tactics", displayName: "Chiến Thuật", maxXp: 100, heroxp: 41, effect: 0.01, description: "XP Quân sự" },
    "Muscle Memory": { name: "Muscle Memory", displayName: "Ký Ức Cơ Bắp", maxXp: 100, heroxp: 42, effect: 0.01, description: "XP Sức mạnh" },

    "Mana Control": { name: "Mana Control", displayName: "Kiểm Soát Mana", maxXp: 100, heroxp: 46, effect: 0.01, description: "XP T.A.A." },
    "Life Essence": { name: "Life Essence", displayName: "Tinh Hoa Sự Sống", maxXp: 100, heroxp: 82, effect: 0.01, description: "Kéo dài tuổi thọ" },
    ...
    "Blood Meditation": { name: "Blood Meditation", displayName: "Thiền Định Máu", maxXp: 100, heroxp: 176, effect: 0.01, description: "Tăng Cường Ác Quỷ" },
    "Demon's Wealth": { name: "Demon's Wealth", displayName: "Của Cải Ác Quỷ", maxXp: 100, heroxp: 178, effect: 0.002, description: "Hero Pay" },
    "Dark Knowledge": { name: "Dark Knowledge", displayName: "Kiến Thức Tăm Tối", maxXp: 100, heroxp: 180, effect: 0.003, description: "XP Anh Hùng" },

    "Void Influence": { name: "Void Influence", displayName: "Ảnh Hưởng Hư Không", maxXp: 100, heroxp: 206, effect: 0.0028, description: "Tất cả XP" },
    "Time Loop": { name: "Time Loop", displayName: "<span style='color: #aa00ff;'>Vòng Lặp Vô Tận</span>", maxXp: 100, heroxp: 207, effect: 0.001, description: "Tốc độ trò chơi" },
    "Evil Incarnate": { name: "Evil Incarnate", displayName: "Hiện Thân Ác Quỷ", maxXp: 100, heroxp: 208, effect: 0.01, description: "XP Kỹ năng" },
    "Absolute Wish": { name: "Absolute Wish", displayName: "<span style='color: #ffaa00;'>Điều Ước Tuyệt Đối</span>", maxXp: 100, heroxp: 198, effect: 0.005, description: "Tăng Cường Ác Quỷ" },
    "Void Amplification": { name: "Void Amplification", displayName: "Khuếch Đại Hư Không", maxXp: 100, heroxp: 251, effect: 0.01, description: "XP Hư Không" },
    "Mind Release": { name: "Mind Release", displayName: "Giải Phóng Tâm Trí", maxXp: 100, heroxp: 251, effect: 0.0006, description: "Tăng Hạnh phúc" },
    "Ceaseless Abyss": { name: "Ceaseless Abyss", displayName: "Vực Thẳm Vô Tận", maxXp: 100, heroxp: 251, effect: 0.000585, description: "Kéo dài tuổi thọ" },
    "Void Symbiosis": { name: "Void Symbiosis", displayName: "Cộng Sinh Hư Không", maxXp: 100, heroxp: 253, effect: 0.0015, description: "XP Kỹ năng" },
    "Void Embodiment": { name: "Void Embodiment", displayName: "Hiện Thân Hư Không", maxXp: 100, heroxp: 258, effect: 0.0025, description: "Tăng Cường Ác Quỷ" },
    "Abyss Manipulation": { name: "Abyss Manipulation", displayName: "Thao Túng Vực Thẳm", maxXp: 100, heroxp: 266, effect: -0.01, description: "Giảm chi phí" },

    "Cosmic Longevity": { name: "Cosmic Longevity", displayName: "Sự Trường Thọ Vũ Trụ", maxXp: 100, heroxp: 266, effect: 0.0015, description: "Kéo dài tuổi thọ" },
    "Cosmic Recollection": { name: "Cosmic Recollection", displayName: "Ký Ức Vũ Trụ", maxXp: 100, heroxp: 272, effect: 0.00065, description: "Nhân Cấp Tối Đa" },
    "Essence Collector": { name: "Essence Collector", displayName: "Người Thu Thập Tinh Hoa", maxXp: 100, heroxp: 288, effect: 0.01, description: "Tăng Cường Tinh Hoa" },
    "Galactic Command": { name: "Galactic Command", displayName: "Chỉ Huy Ngân Hà", maxXp: 100, heroxp: 290, effect: -0.01, description: "Giảm chi phí" },

    "Yin Yang": { name: "Yin Yang", displayName: "Âm Dương", maxXp: 100, heroxp: 290, effect: 0.020, description: "Tăng Cường Tinh Hoa + Ác Quỷ" },
    "Parallel Universe": { name: "Parallel Universe", displayName: "Vũ Trụ Song Song", maxXp: 100, heroxp: 300, effect: 0.02, description: "Tất cả XP" },
    "Higher Dimensions": { name: "Higher Dimensions", displayName: "Chiều Không Gian Cao Hơn", maxXp: 100, heroxp: 300, effect: 0.001, description: "Kéo dài tuổi thọ" },
    "Epiphany": { name: "Epiphany", displayName: "Sự Khai Sáng", maxXp: 100, heroxp: 280, effect: 0.012, description: "XP Hội Đồng Ngân Hà" },

    "Dark Prince": { name: "Dark Prince", displayName: "Hoàng Tử Bóng Tối", maxXp: 100, heroxp: 350, effect: 0.01, description: "XP Kỹ năng" },
    "Dark Ruler": { name: "Dark Ruler", displayName: "Chúa Tể Bóng Tối", maxXp: 100, heroxp: 375, effect: 0.0000015, description: "Tăng Cường Vật Chất Tối" },
    "Immortal Ruler": { name: "Immortal Ruler", displayName: "Chúa Tể Bất Tử", maxXp: 100, heroxp: 425, effect: 0.01, description: "Tất cả XP" },
    "Dark Magician": { name: "Dark Magician", displayName: "Pháp Sư Bóng Tối", maxXp: 100, heroxp: 475, effect: 0.0000025, description: "Tăng Cường Tinh Hoa" },
    "Universal Ruler": { name: "Universal Ruler", displayName: "Chúa Tể Vũ Trụ", maxXp: 100, heroxp: 500, effect: 1, description: "XP Phép thuật" },
    "Blinded By Darkness": { name: "Blinded By Darkness", displayName: "Mù Quáng Bởi Bóng Tối", maxXp: 100, heroxp: 550, effect: 1, description: "Tất cả XP" },
}

const itemBaseData = {
     
    "Homeless": { name: "Homeless", displayName: "Vô Gia Cư", expense: 0, effect: 1, heromult: 2, heroeffect: 2e6 },
    "Tent": { name: "Tent", displayName: "Lều", expense: 15, effect: 1.4, heromult: 2, heroeffect: 2e7 },

    "Wooden Hut": { name: "Wooden Hut", displayName: "Túp Lều Gỗ", expense: 100, effect: 2, heromult: 3, heroeffect: 2e8 },
    "Cottage": { name: "Cottage", displayName: "Nhà Tranh", expense: 750, effect: 3.5, heromult: 3, heroeffect: 2e9 },
    "House": { name: "House", displayName: "Căn Nhà", expense: 3000, effect: 6, heromult: 4, heroeffect: 2e10 },
    "Large House": { name: "Large House", displayName: "Nhà Lớn", expense: 25000, effect: 12, heromult: 4, heroeffect: 2e11 },
    "Small Palace": { name: "Small Palace", displayName: "Cung Điện Nhỏ", expense: 300000, effect: 25, heromult: 5, heroeffect: 2e12 },
    "Grand Palace": { name: "Grand Palace", displayName: "Cung Điện Lớn", expense: 5000000, effect: 60, heromult: 5, heroeffect: 2e13 },
    "Town Ruler": { name: "Town Ruler", displayName: "Người Cai Trị Thị Trấn", expense: 35000000, effect: 120, heromult: 6, heroeffect: 2e15 },
    "City Ruler": { name: "City Ruler", displayName: "Người Cai Trị Thành Phố", expense: 1.1e9, effect: 500, heromult: 7, heroeffect: 2e17 },
    "Nation Ruler": { name: "Nation Ruler", displayName: "Người Cai Trị Quốc Gia", expense: 1.3e10, effect: 1200, heromult: 8, heroeffect: 2e19 },
    "Pocket Dimension": { name: "Pocket Dimension", displayName: "Chiều Không Gian Nhỏ", expense: 4.9e10, effect: 5000, heromult: 9, heroeffect: 2e22 },
    "Void Realm": { name: "Void Realm", displayName: "Cõi Hư Không", expense: 1.21e11, effect: 15000, heromult: 10, heroeffect: 2e25 },
    "Void Universe": { name: "Void Universe", displayName: "Vũ Trụ Hư Không", expense: 2e12, effect: 30000, heromult: 11, heroeffect: 2e28 },
    "Astral Realm": { name: "Astral Realm", displayName: "Cõi Tinh Tú", expense: 1.6e14, effect: 150000, heromult: 12, heroeffect: 2e31 },
    "Galactic Throne": { name: "Galactic Throne", displayName: "Ngai Vàng Ngân Hà", expense: 5e15, effect: 300000, heromult: 13, heroeffect: 2e35 },
    "Spaceship": { name: "Spaceship", displayName: "Tàu Vũ Trụ", expense: 1e18, effect: 1500000, heromult: 15, heroeffect: 5e42 },
    "Planet": { name: "Planet", displayName: "Hành Tinh", expense: 1e22, effect: 5000000, heromult: 16, heroeffect: 5e46 },
    "Ringworld": { name: "Ringworld", displayName: "Thế Giới Vành Đai", expense: 1e24, effect: 50000000, heromult: 17, heroeffect: 5e49 },

    // Heroic only
    "Stellar Neighborhood": { name: "Stellar Neighborhood", displayName: "Khu Vực Vì Sao", expense: 1e27, effect: 60000000, heromult: 17, heroeffect: 6e49,  },
    "Galaxy": { name: "Galaxy", displayName: "Ngân Hà", expense: 1e30, effect: 75000000, heromult: 18, heroeffect: 7.5e49 },
    "Supercluster": { name: "Supercluster", displayName: "Siêu Quần Ngân Hà", expense: 1e33, effect: 100000000, heromult: 20, heroeffect: 1e50 },
    "Galaxy Filament": { name: "Galaxy Filament", displayName: "Dải Ngân Hà", expense: 1e36, effect: 1000000000, heromult: 25, heroeffect: 1e52 },
    "Observable Universe": { name: "Observable Universe", displayName: "Vũ Trụ Có Thể Quan Sát", expense: 1e39, effect: 10000000000, heromult: 30, heroeffect: 1e54 },
    "Multiverse": { name: "Multiverse", displayName: "Đa Vũ Trụ", expense: 1e42, effect: 100000000000, heromult: 35, heroeffect: 1e60 },
    "Quantum World": { name: "Quantum World", displayName: "Thế Giới Lượng Tử", expense: 1e49, effect: 1000000000000, heromult: 40, heroeffect: 1e64 },
    "Boötes Void": { name: "Boötes Void", displayName: "Khoảng Trống Boötes", expense: 3e74, effect: 1000000000000, heromult: 40, heroeffect: 1e80 },

    // Misc
    "Book": { name: "Book", displayName: "Sách", expense: 10, effect: 1.5, description: "XP Kỹ năng", heromult: 2, heroeffect: 10 },
    "Dumbbells": { name: "Dumbbells", displayName: "Tạ", expense: 50, effect: 1.5, description: "XP Sức mạnh", heromult: 2, heroeffect: 10 },
    "Personal Squire": { name: "Personal Squire", displayName: "Người Hầu Cá Nhân", expense: 200, effect: 2, description: "XP Anh Hùng", heromult: 3, heroeffect: 10 },
    "Steel Longsword": { name: "Steel Longsword", displayName: "Kiếm Dài Thép", expense: 1000, effect: 2, description: "XP Quân sự", heromult: 3, heroeffect: 10 },
    "Butler": { name: "Butler", displayName: "Quản Gia", expense: 7500, effect: 1.5, description: "Hạnh phúc", heromult: 4, heroeffect: 10 },
    "Sapphire Charm": { name: "Sapphire Charm", displayName: "Bùa Sapphire", expense: 50000, effect: 3, description: "XP Phép thuật", heromult: 4, heroeffect: 10 },
    "Study Desk": { name: "Study Desk", displayName: "Bàn Học", expense: 1000000, effect: 2, description: "XP Kỹ năng", heromult: 5, heroeffect: 10 },
    "Library": { name: "Library", displayName: "Thư Viện", expense: 1e7, effect: 2, description: "XP Kỹ năng", heromult: 5, heroeffect: 10 },
    "Observatory": { name: "Observatory", displayName: "Đài Quan Sát", expense: 1.4e8, effect: 5, description: "XP Phép thuật", heromult: 6, heroeffect: 10 },
    "Mind's Eye": { name: "Mind's Eye", displayName: "Tâm Nhãn", expense: 3.25e9, effect: 10, description: "XP Cơ bản", heromult: 8, heroeffect: 10 },
    "Void Necklace": { name: "Void Necklace", displayName: "Vòng Cổ Hư Không", expense: 2.8e10, effect: 3, description: "XP Thao Túng Hư Không", heromult: 10, heroeffect: 10 },
    "Void Armor": { name: "Void Armor", displayName: "Áo Giáp Hư Không", expense: 1.97e11, effect: 3, description: "XP Hư Không", heromult: 10, heroeffect: 10 },
    "Void Blade": { name: "Void Blade", displayName: "Lưỡi Kiếm Hư Không", expense: 5e11, effect: 3, description: "XP Kỹ năng", heromult: 11, heroeffect: 10 },
    "Void Orb": { name: "Void Orb", displayName: "Cầu Hư Không", expense: 1.2e12, effect: 3, description: "XP Thao Túng Hư Không", heromult: 11, heroeffect: 10 },
    "Void Dust": { name: "Void Dust", displayName: "Bụi Hư Không", expense: 2.5e13, effect: 3, description: "XP Hư Không", heromult: 12, heroeffect: 10 },
    "Celestial Robe": { name: "Celestial Robe", displayName: "Trang Phục Celestial", expense: 3e14, effect: 5, description: "XP Hội Đồng Ngân Hà", heromult: 12, heroeffect: 10 },
    "Universe Fragment": { name: "Universe Fragment", displayName: "Mảnh Vỡ Vũ Trụ", expense: 1.85e16, effect: 3, description: "XP Kỹ năng", heromult: 13, heroeffect: 1000000 },
    "Multiverse Fragment": { name: "Multiverse Fragment", displayName: "Mảnh Vỡ Đa Vũ Trụ", expense: 2e17, effect: 5, description: "Hạnh phúc", heromult: 15, heroeffect: 1000000 },
    "Stairway to heaven": { name: "Stairway to heaven", displayName: "Nấc Thang Lên Thiên Đường", expense: 1e38, effect: 10, description: "Hạnh phúc", heromult: 30, heroeffect: 1000000 },
    "Highway to hell": { name: "Highway to hell", displayName: "Đường Xuống Địa Ngục", expense: 1e42, effect: 10, description: "Tăng Cường Ác Quỷ", heromult: 30, heroeffect: 1000000 },
    "Tesseract": { name: "Tesseract", displayName: "Khối Tesseract", expense: 1e48, effect: 1, description: "Tăng Cường Hypercube", heromult: 30, heroeffect: 10 },
    "Desintegration": { name: "Desintegration", displayName: "Sự Phân Rã", expense: 1e55, effect: 1, description: "Tăng Cường Vật Chất Tối", heromult: 30, heroeffect: 100 },
    "Custom Galaxy": { name: "Custom Galaxy", displayName: "Ngân Hà Tùy Chỉnh", expense: 1e64, effect: 1, description: "XP Kỹ năng", heromult: 30, heroeffect: 1e100 },
    "Hypersphere": { name: "Hypersphere", displayName: "Siêu Cầu", expense: 1e91, effect: 1, description: "Tăng Cường Hypercube", heromult: 30, heroeffect: 1e50 },
}
